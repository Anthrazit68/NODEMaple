# NODESteelProfiles_CF_RHS.mm: hot formed rectangular hollow sections
...
NODESteelProfiles_HF_RHS:= module()
	uses NODEFunctions;
	description "HF RHS profiles";
    option package;
	export Property: 
	
   local metadata, dataTable, parNames, memberNames, parPos;
	
$include "Steel/Data_HF_RHS.mm"
