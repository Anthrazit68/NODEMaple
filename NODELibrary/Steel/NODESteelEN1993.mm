...
NODESteelEN1993 := module()
	description "Dimensioning of steel structures according to EN1993-1-1";
	option package;
	uses Units[Simple];
	
	export GetMaterialdata, GetSectiondata, SetComboBoxMaterial, SetComboBoxSection;
	
	local SectiondataRectangular;
